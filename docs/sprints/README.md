...
| Sprint | 狀態 | 說明 |
| --- | --- | --- |
| Sprint 1：社區基本資料 | 核心完成 | 區公所名冊 33 筆已同步至發布層；未由官方來源確認的擴充欄位列為 TODO |
| Sprint 2：2023–2026 活動 | 完成 | 50 筆政府核定方案已發布；證據只支持核定與預定期間 |
| Sprint 3：SDGs | 待人工覆核 | 50 筆逐活動候選已建立；正式映射數仍為 0 |
...
目標：逐一研究 33 個協會在 2023–2026 年間可驗證的活動。
